...
L = 1;     % Length of the pendulum (meters)
...
% Solver options
options = odeset('MaxStep', 0.001, 'InitialStep', 0.001);  % Set maximum and initial step sizes
...
data = table(t, theta, p, KE, PE, TE, 'VariableNames', ...
    {'Time', 'Pendulum Angle', 'Angular Momentum', 'Kinetic Energy', 'Potential Energy', 'Total Energy'});

% Save data
writetable(data, 'pendulum_verification_data.csv');
